...
extension UITableView {
    ...
    func setEmptyView(title: String, message: String,image: UIImage? = nil,randeringMode: UIImage.RenderingMode = .alwaysTemplate) {
        ...
        imageView.image = image?.withRenderingMode(randeringMode)
